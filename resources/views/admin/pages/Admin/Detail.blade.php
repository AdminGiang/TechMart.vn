        ...
        <div class="product-detail-container">
            ...
            <div class="product-info">
                ...
                <div class="action-buttons">
                    <a href="{{ route('admin.pages.Admin.edit') }}" class="btn btn-edit">Chỉnh sửa sản phẩm</a>
                    <a href="{{ route('admin.pages.Admin.index') }}" class="btn btn-back">Quay lại danh sách</a>
                </div>
            </div>
        </div>
    </div>
